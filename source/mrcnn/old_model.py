...
class MaskRCNN(object):
    ...
    def __init__(self, mode, config, model_dir, log_dir=None):
        """
    ...
    def build(self, mode, config):
        ...
        """
        assert mode in ["training", "inference"]
        logger.info("Build MaskRCNN model with {} mode".format(mode))
    ...
    def load_weights(self, filepath, by_name=False, exclude=None):
        ...
        with h5py.File(filepath, mode="r") as f:
            ...
            if by_name:
                ...
                hdf5_format.load_weights_from_hdf5_group(f, layers, skip_mismatch=True)
